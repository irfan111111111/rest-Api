...
$result = get_Curl("https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id=UCf7ucy4daDIPDV-JuW3kYbQ&key=AIzaSyBELqxj9iVEEF5akA0e17dYNiFzmoeO998");
...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#home">Rahmad Irfan</a>
    ...
    <section class="about" id="about">
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-md-5">
            <p>Halo, saya Rahmad Irfan, Saat ini saya fokus di bidang pengembangan website dan teknologi informasi. Saya sudah mengerjakan beberapa proyek sederhana seperti sistem informasi keuangan, presensi, dan manajemen proyek berbasis website.

              Saya senang belajar hal-hal baru, khususnya yang berkaitan dengan teknologi, desain, dan konten digital.</p>
          </div>
          <div class="col-md-5">
            <p>Saya memiliki pengetahuan yang luas tentang pengembangan website dan teknologi informasi, serta pengalaman dalam merancang dan mengembangkan sistem informasi yang kompleks.</p>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row justify-content-center">
          <div class="col-md-5">
            <div class="row">
              ...
              <div class="col-md-8">
                <h5>Irfan Channel 1</h5>
                <p><?= $subscriber ?> Subscribers.</p>
                <div class="g-ytsubscribe" data-channelid="UCf7ucy4daDIPDV-JuW3kYbQ" data-layout="default" data-count="default"></div>
              </div>
            </div>
            <div class="row mt-3 pb-3">
              <div class="col">
                <div class="embed-responsive embed-responsive-16by9">
                <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/N6sb8NjUu8U?" allowfullscreen></iframe>
              </div>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="row">
              <div class="col md-4">
                <img src="img/profile1.jpg" width="200" class="rounded-circle img-thumbnail">
              </div>
              <div class="col-md-8">
                <h5>Rahmad_Irfan76</h5>
                <p> 2760 Followers.</p>
              </div>
            </div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-4">
            ...
            <ul class="list-group mb-4">
              ...
              <li class="list-group-item">Jl. Jati baru No. 193, Padang</li>
